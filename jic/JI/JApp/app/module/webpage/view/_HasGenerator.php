...
trait _HasGenerator
{
	...
	{
		return $this->j()->mPubFileStore()->url( $this->_styleFileName() );
	}

	public function scriptURL()
	{
		return $this->j()->mPubFileStore()->url( $this->_scriptFileName() );
	}

	public function linkScript()
	{
		$this->app()->response()->page()->script()->link( $this->name(), $this->scriptURL() );
	}

	public function linkStyle()
	{
		$this->app()->response()->page()->style()->link( $this->name(), $this->styleURL() );
	}
